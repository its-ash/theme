...
The `example/` app is a running showcase — it bundles several demo apps (an e-commerce app, a blog, an astrology app) all built entirely from this package's components. Try it live at the [demo link above](https://its-ash.github.io/theme/), or run it locally:
